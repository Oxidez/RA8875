...
/*
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// drawButton(button_shape, button_x, button_y, button_width, button_height, button_radius, button_col1, button_col2, button_textColor, button_fontSize, button_textOffset, button_text);
      // Variable 'button_shape' defines the shape of the button
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*/
void RA8875::drawButton(uint16_t button_shape, uint16_t button_x, uint16_t button_y, uint16_t button_width, uint16_t button_height, uint16_t button_radius, uint16_t button_col1, uint16_t button_col2, uint16_t button_textColor, uint16_t button_fontSize, int button_textOffset, const char* button_text) {
  uint16_t cursorX;
  uint16_t cursorY;
  // Change the button type acording to the choosed shape
  switch (button_shape) {
    case 0:  // Filled rectangle button
      fillRect(button_x, button_y, button_width, button_height, button_col1);
      break;
    case 1:  // Filled rectangle button with round corners
      fillRoundRect(button_x, button_y, button_width, button_height, button_radius, button_col1);
      break;
    case 2:  // Rectangle button
      drawRect(button_x, button_y, button_width, button_height, button_col1);
      drawRect(button_x + 1, button_y + 1, button_width - 2, button_height - 2, button_col1);
      drawRect(button_x + 2, button_y + 2, button_width - 4, button_height - 4, button_col1);
      fillRect(button_x + 3, button_y + 3, button_width - 6, button_height - 6, button_col2);
      break;
    case 3:  // Rectangle button with round corners
      drawRoundRect(button_x, button_y, button_width, button_height, button_radius, button_col1);
      drawRoundRect(button_x + 1, button_y + 1, button_width - 2, button_height - 2, button_radius, button_col1);
      drawRoundRect(button_x + 2, button_y + 2, button_width - 4, button_height - 4, button_radius, button_col1);
      fillRoundRect(button_x + 3, button_y + 3, button_width - 6, button_height - 6, button_radius, button_col2);
      break;
    case 4:  // Round button
      drawCircle(button_x, button_y, button_radius, button_col1);
      drawCircle(button_x, button_y, button_radius - 1, button_col1);
      drawCircle(button_x, button_y, button_radius - 2, button_col1);
      fillCircle(button_x, button_y, button_radius - 3, button_col2);
      break;
    case 5:  // Filled round button
      fillCircle(button_x, button_y, button_radius, button_col1);
      break;
    case 6:  // Elipse
      drawEllipse(button_x, button_y, button_width, button_height, button_col1);
      drawEllipse(button_x, button_y, button_width-1, button_height-1, button_col1);
      drawEllipse(button_x, button_y, button_width-2, button_height-2, button_col1);
      fillEllipse(button_x, button_y, button_width-3, button_height-3, button_col2);
      break;
    case 7:  // Filled elipse
      fillEllipse(button_x, button_y, button_width, button_height, button_col1);
      break;
          // case 8:  // Triangle
          // tft.drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color);
          // break;
          // case 9:  // Filled triangle
          // tft.fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color);
          // break;
  };
  if ((button_shape >= 0) && (button_shape < 4)) {
    cursorX = (button_x + (button_width / 2));
    cursorY = (button_y + (button_height / 1.75) + (button_textOffset));
  } else if ((button_shape >= 4) && (button_shape <= 7)) {
    cursorX = button_x+5;
    cursorY = ((button_y + 5) + (button_textOffset));
  } else {
  // Nothing here
  } 
  // Write the text for the button
  setCursor(cursorX, cursorY, true);    // Coordinates X and Y - auto center on X axis
  setTextColor(button_textColor);       // Text color
  setFontScale(button_fontSize);        // Size of text
  print(button_text);                   // Write the text inside the button
}	  
